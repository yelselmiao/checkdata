...
4. Create a remote repository in github.com and named as "checkdata"
4. Run the following command to push the local package framework to the "checkdata" repo  
